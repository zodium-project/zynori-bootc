...
Singleton {
  ...
  */
  ...
  readonly property string defaultWallpapersDirectory: "/usr/share/wallpapers"
  ...
  Component.onCompleted: {
    ...
    adapter.ui.fontDefault = "Cantarell";
    adapter.ui.fontFixed = "Hack Nerd Font Mono";
  ...
  JsonAdapter {
    ...
    property JsonObject general: JsonObject {
      ...
      property real dimmerOpacity: 0.3
      ...
      property bool lockScreenAnimations: true
      ...
      property bool enableBlurBehind: false
      property string shadowDirection: "center"
    ...
    property JsonObject appLauncher: JsonObject {
      ...
      property string terminalCommand: "ghostty -e"
    ...
    property JsonObject noctaliaPerformance: JsonObject {
      property bool disableWallpaper: false
